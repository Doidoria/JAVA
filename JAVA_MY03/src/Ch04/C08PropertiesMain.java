...
public class C08PropertiesMain {
	...
	public static void main(String[] args) throws IOException {
		...
		String dirPath = System.getProperty("user.dir");		//어플리케이션 프로포트 위치 찾기
		...
		System.out.println("filePath : "+filePath); 			//파일 위치 찾기
		FileInputStream fin = new FileInputStream(filePath);	//파일안에 내용을 자바안으로 가져오기 위함
