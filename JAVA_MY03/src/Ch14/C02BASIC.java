...
//		Object result = method.invoke(ob,null);		//ob에 있는 Age를 꺼내옴 (메서드의 공용 공간에 있는걸 꺼내옴)
//		System.out.println(result);
		
		//reflect로 생성자 사용하기
//		Constructor<?> constructor = clazz.getConstructor(String.class); //인자1 개받는 생성자 (생성자 함수를 꺼내옴)
//		System.out.println(constructor);
//		Object obj =  constructor.newInstance("홍길동");
//		System.out.println(obj);
	
		//reflect로 field에 값넣기
//		Field field = clazz.getDeclaredField("addr"); //선언된 필드중에 addr 꺼내옴
//		field.set(ob, "대구");
