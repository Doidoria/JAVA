...
public class C10SelenumAPIMain {
	...
	private static final String WEB_DRIVER_ID="webdirver.chrome.driver";
	private static final String WEB_DRIVER_PATH="src/drivers/chromedriver.exe";
	
	public static void main(String[] args) throws IOException {
		//Selenum 3.x 기준 브라우저 활성화 방법(4.x 부터는 chromedriver.exe 를 윈도우 PATH에 등록시 경로설정 필요없음)
