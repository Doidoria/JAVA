...
//					.filter((obj)->{return obj instanceof Integer;})	//obj 자료형이 Integer 라면 내려감
					.filter(obj->obj instanceof Integer)
//					.map((obj)->{return (Integer)obj;})					//(Integer)형으로 다운캐스팅
					.map(obj->(Integer)obj)
					.collect(Collectors.toList());
		};
		System.out.println(func3.sum(10,20,30.5,"홍길동",true)); //"Integer"형만 출력
