...
class Tv implements Remocon{
	...
	public void setVolumn(int vol) {
		if(vol>MAX_VOL) {
			vol=MAX_VOL;
			System.out.println("TV : 최대불륨으로 설정합니다.");
		}else if(vol<MIN_VOL) {
			vol=MIN_VOL;
			System.out.println("TV : 최소불륨으로 설정합니다.");
		}else {
			this.vol=vol;
			System.out.println("TV 현재 불륨 : "+this.vol);
		}
	}
...
class Radio implements Remocon{
	...
	public void setVolumn(int vol) {
		if(vol>MAX_VOL) {
			vol=MAX_VOL;
			System.out.println("Radio : 최대불륨으로 설정합니다.");
		} else if(vol<MIN_VOL) {
			vol=MIN_VOL;
			System.out.println("Radio : 최소불륨으로 설정합니다.");
		} else {
			this.vol=vol;
			System.out.println("Radio 현재 불륨 : "+this.vol);
		}
