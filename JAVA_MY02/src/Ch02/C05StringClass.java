...
//		}
		...
		System.out.println("인덱스 찾기 : " + str1.indexOf('a')); //왼쪽 -> 오른쪽 a 찾기
		System.out.println("인덱스 찾기 : " + str1.lastIndexOf('a')); //왼쪽 <- 오른쪽 a 찾기
		
		System.out.println("문자열포함 여부 : " + str1.contains("va"));
		System.out.println("문자열포함 여부 : " + str1.contains("abs"));
		
		System.out.println("문자열 자르기 : " + (str1.substring(2,6))); //문자 2번째부터 6번째까지
